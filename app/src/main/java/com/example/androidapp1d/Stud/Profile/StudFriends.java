...
public class StudFriends extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friendsRef = firebaseDatabase.getReference().child("Students");
    ...
    public void display(){
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(StudFriends.this, StudPersonalDetails.class);
